...
def get_c4(nsamples, seed, seqlen, model):
    from datasets import load_dataset
    trainds = load_dataset('c4', 'en', split='train', streaming=True)
    valds = load_dataset('c4', 'en', split='validation', streaming=True)

    traindata = trainds.shuffle(buffer_size=10_000, seed=42)
    valdata = valds.shuffle(buffer_size=10_000, seed=42)
