...
# python swin_quip.py --exp_name ${swin_models[$var]} --parent_dir ffq_red_1p1 --wbits 2 --Weiner_m_diag_rank 0 --quant ldlq --pre_tff --pre_gptqH --qfn s --eval_batch_size 8 --tff_redundancy 1.1 --x_sigma 2.0 --timm_model_name ${swin_models[$var]} --pre_proj --percdamp 0.01 --img_size ${img_sizes[$var]}
# sleep 2
# done
...
# python cait_quip.py --exp_name ${cait_models[$var]} --parent_dir ffq_red_1p1 --wbits 2 --Weiner_m_diag_rank 0 --quant ldlq --pre_tff --pre_gptqH --qfn s --eval_batch_size 1 --tff_redundancy 1.1 --x_sigma 2.0 --timm_model_name ${cait_models[$var]} --pre_proj --percdamp 0.01 --img_size ${img_sizes[$var]}
# sleep 2
# done
...
# python vit_quip.py --exp_name ${deit_models[$var]} --parent_dir ffq_red_1p1 --wbits 2 --Weiner_m_diag_rank 0 --quant ldlq --pre_tff --pre_gptqH --qfn s --eval_batch_size 8 --tff_redundancy 1.1 --x_sigma 2.0 --timm_model_name ${deit_models[$var]} --pre_proj --percdamp 0.01 --img_size ${img_sizes[$var]}
# sleep 2
# done
...
do
echo ${vit_models[$var]}
python vit_quip.py --exp_name ${vit_models[$var]} --parent_dir ffq_red_1p1 --wbits 2 --Weiner_m_diag_rank 0 --quant ldlq --pre_tff --pre_gptqH --qfn s --eval_batch_size 8 --tff_redundancy 1.1 --x_sigma 2.0 --timm_model_name ${vit_models[$var]} --pre_proj --percdamp 0.01 --img_size ${img_sizes[$var]}
sleep 2
done
...
# vit_models=(cait_m36_384.fb_dist_in1k)
# 
# for var in ${!vit_models[@]}
# do
# echo ${vit_models[$var]}
...
# python vit_quip.py --exp_name debug_thread --parent_dir ffq_red_1p1 --wbits 2 --Weiner_m_diag_rank 0 --quant ldlq --pre_tff --pre_gptqH --qfn s --eval_batch_size 8 --tff_redundancy 1.1 --x_sigma 2.0 --timm_model_name ${vit_models[$var]} --train_batch_path ./data/train_batch_2.pt --pre_proj --percdamp 0.01
# sleep 2
# done

# # vit_models=(cait_s24_384.fb_dist_in1k cait_m48_448.fb_dist_in1k cait_m36_384.fb_dist_in1k)
# vit_models=(cait_s24_384.fb_dist_in1k)
# img_sizes=(384 448 384)
# 
# for var in ${!vit_models[@]}
# do
# echo ${vit_models[$var]}
# # python cait_quip.py --exp_name ${vit_models[$var]} --parent_dir ffq_red_1p1 --wbits 2 --Weiner_m_diag_rank 0 --quant ldlq --pre_tff --pre_gptqH --qfn s --eval_batch_size 8 --tff_redundancy 1.1 --x_sigma 2.0 --timm_model_name ${vit_models[$var]} --train_batch_path ./data/train_batch_2.pt --pre_proj --percdamp 0.02
# python cait_quip.py --exp_name debug_thread --parent_dir ffq_red_1p1 --wbits 2 --Weiner_m_diag_rank 0 --quant ldlq --pre_tff --pre_gptqH --qfn s --eval_batch_size 8 --tff_redundancy 1.1 --x_sigma 2.0 --timm_model_name ${vit_models[$var]} --train_batch_path ./data/train_batch_2.pt --pre_proj --percdamp 0.01 --img_size ${img_sizes[$var]}
# sleep 2
# done