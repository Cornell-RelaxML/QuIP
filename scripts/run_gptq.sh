...
# python swin_quip.py --exp_name ${swin_models[$var]} --parent_dir gptq --wbits 2 --quant gptq --eval_batch_size 8 --pre_gptqH --qfn a --timm_model_name ${swin_models[$var]} --img_size ${img_sizes[$var]}
# sleep 2
# done
...
# python cait_quip.py --exp_name ${cait_models[$var]} --parent_dir gptq --wbits 2 --quant gptq --eval_batch_size 1 --pre_gptqH --qfn a --timm_model_name ${cait_models[$var]} --img_size ${img_sizes[$var]}
# sleep 2
# done
...
# python vit_quip.py --exp_name ${deit_models[$var]} --parent_dir gptq --wbits 2 --quant gptq --eval_batch_size 8 --pre_gptqH --qfn a --timm_model_name ${deit_models[$var]} --img_size ${img_sizes[$var]}
# sleep 2
# done
...
do
echo ${vit_models[$var]}
python vit_quip.py --exp_name ${vit_models[$var]} --parent_dir gptq --wbits 2 --quant gptq --eval_batch_size 8 --pre_gptqH --qfn a --timm_model_name ${vit_models[$var]} --img_size ${img_sizes[$var]}
sleep 2
done
