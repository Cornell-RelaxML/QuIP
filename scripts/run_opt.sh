...
# 
# redundancy
python llama.py facebook/opt-125m c4 --eval --exp_name opt_125m_fq_2   --tff_redundancy 1.0 --new_eval --wbits 2 --quant ldlq --pre_gptqH --pre_tff --qfn s --x_sigma 2.0 --pre_proj 
python llama.py facebook/opt-125m c4 --eval --exp_name opt_125m_fq_2p2 --tff_redundancy 1.1 --new_eval --wbits 2 --quant ldlq --pre_gptqH --pre_tff --qfn s --x_sigma 2.0 --pre_proj 
python llama.py facebook/opt-125m c4 --eval --exp_name opt_125m_fq_2p4 --tff_redundancy 1.2 --new_eval --wbits 2 --quant ldlq --pre_gptqH --pre_tff --qfn s --x_sigma 2.0 --pre_proj 
