...
# python cait_quip.py --exp_name ${cait_models[$var]} --parent_dir quip --wbits 2 --quant ldlq --eval_batch_size 1 --pre_gptqH --pre_proj --qfn b --timm_model_name ${cait_models[$var]} --img_size ${img_sizes[$var]}
# sleep 2
# done
# 
# for var in ${!cait_models[@]}
# do
# echo ${cait_models[$var]}
# python cait_quip.py --exp_name ${cait_models[$var]} --parent_dir quip_2sig --wbits 2 --quant ldlq --eval_batch_size 1 --pre_gptqH --pre_proj --qfn s --x_sigma 2 --timm_model_name ${cait_models[$var]} --img_size ${img_sizes[$var]}
# sleep 2
# done
...
# python vit_quip.py --exp_name ${deit_models[$var]} --parent_dir quip --wbits 2 --quant ldlq --eval_batch_size 8 --pre_gptqH --pre_proj --qfn b --timm_model_name ${deit_models[$var]} --img_size ${img_sizes[$var]}
# sleep 2
# done
# 
# for var in ${!deit_models[@]}
# do
# echo ${deit_models[$var]}
# python vit_quip.py --exp_name ${deit_models[$var]} --parent_dir quip_2sig --wbits 2 --quant ldlq --eval_batch_size 8 --pre_gptqH --pre_proj --qfn s --x_sigma 2 --timm_model_name ${deit_models[$var]} --img_size ${img_sizes[$var]}
# sleep 2
# done
...
# do
# echo ${vit_models[$var]}
# python vit_quip.py --exp_name ${vit_models[$var]} --parent_dir quip --wbits 2 --quant ldlq --eval_batch_size 64 --pre_gptqH --pre_proj --qfn b --timm_model_name ${vit_models[$var]} --train_batch_path ./data/train_batch_2.pt
# sleep 2
# done
# 
...
# do
# echo ${swin_models[$var]}
# python swin_quip.py --exp_name ${swin_models[$var]} --parent_dir quip --wbits 2 --quant ldlq --eval_batch_size 16 --pre_gptqH --pre_proj --qfn b --timm_model_name ${swin_models[$var]} --train_batch_path ./data/train_batch_2.pt
# sleep 2
# done
...
# do
# echo ${vit_models[$var]}
# python vit_quip.py --exp_name ${vit_models[$var]} --parent_dir quip_2sig --wbits 2 --quant ldlq --eval_batch_size 64 --pre_gptqH --pre_proj --qfn s --x_sigma 2 --timm_model_name ${vit_models[$var]} --train_batch_path ./data/train_batch_2.pt
# sleep 2
# done
# 
# swin_models=(swin_small_patch4_window7_224 swin_base_patch4_window7_224 swin_base_patch4_window12_384)
...
# do
# echo ${swin_models[$var]}
# python swin_quip.py --exp_name ${swin_models[$var]} --parent_dir quip_2sig --wbits 2 --quant ldlq --eval_batch_size 16 --pre_gptqH --pre_proj --qfn s --x_sigma 2 --timm_model_name ${swin_models[$var]} --train_batch_path ./data/train_batch_2.pt
# sleep 2
# done
...
# do
# echo ${vit_models[$var]}
# python vit_quip.py --exp_name ${vit_models[$var]} --parent_dir quip --wbits 2 --quant ldlq --eval_batch_size 8 --pre_gptqH --pre_proj --qfn b --timm_model_name ${vit_models[$var]} --train_batch_path ./data/train_batch_2.pt
# sleep 2
# done
# 
# # vit_models=(vit_huge_patch14_clip_224.laion2b_ft_in1k vit_large_patch16_224.augreg_in21k_ft_in1k)
...
# do
# echo ${vit_models[$var]}
# python vit_quip.py --exp_name ${vit_models[$var]} --parent_dir quip_2sig --wbits 2 --quant ldlq --eval_batch_size 8 --pre_gptqH --pre_proj --qfn s --x_sigma 2 --timm_model_name ${vit_models[$var]} --train_batch_path ./data/train_batch_2.pt
# sleep 2
# done