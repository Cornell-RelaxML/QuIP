...
# # TFF redundancy 2x
# without symm scale
python vit_quip.py --coef_est_type weiner --exp_name debug_thread --wbits 2 --Weiner_m_diag_rank 0 --quant ldlq --pre_tff --pre_gptqH --qfn a --eval_batch_size 64 --tff_redundancy 2
# with symm scale
